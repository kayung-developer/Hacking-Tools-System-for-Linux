...
If you find a bug or bug, you can contact me using mail. princekayung@gmail.com


View My Other Projects On Github:

https://github.com/kayung-developer
...
{color.BLUE}[!] You can run this script only on debian system.{color.RESET_ALL}

        
View My Other Projects On Github:

{color.YELLOW}https://github.com/kayung-developer{color.RESET_ALL}
